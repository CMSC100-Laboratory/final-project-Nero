  ...
  return (
    <div className="min-h-screen flex flex-col bg-background relative overflow-hidden font-sans">
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-12 relative z-10">
        ...
        >
          {/* Left – Visual Panel */}
          <div className="relative md:w-[45%] min-h-[250px] md:min-h-[680px] overflow-hidden group">
            <motion.img
              initial={{ scale: 1.1 }}
              animate={{ scale: 1 }}
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-10 md:p-14">
              ...
              >
                ...
                <p className="text-white/80 text-lg leading-relaxed max-w-sm font-medium">
                  Join our community of farmers and fresh produce lovers.
                </p>
          ...
          <div className="flex-1 flex flex-col justify-center px-8 md:px-16 py-12 md:py-16 bg-card/20">
            <motion.div variants={itemVariants} className="mb-8">
              <h1 className="font-display text-4xl font-black text-foreground tracking-tight mb-2 text-center md:text-left">
                Create Account
              </h1>
                ...
                <motion.div variants={itemVariants} className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <Input
                      ...
                      required
                      className="h-12 pl-12 bg-transparent border-border/40 rounded-2xl text-foreground placeholder:text-muted-foreground/50 focus-visible:ring-primary/30 focus-visible:bg-transparent focus-visible:border-primary/50 transition-all autofill:bg-transparent"
                    />
                  </div>
                </motion.div>
